...
sub parse_server {
  ...
  $value{pending_wait_file} = $param_arg->{pending_wait_file};
  if ( !defined( $value{pending_wait_file} ) ) {
    $value{pending_wait_file} = $default->{pending_wait_file};
  }
